...
pub use catalog::{
    ...
    IndexState, InlineChunk, LiveCount, LocatedDeletion, LocatedPositions, LocatedRowScan,
    LocatedRows, MacroId, MacroImplementationDef, MacroInfo, MacroParameterDef, MaintenanceReport,
    MaintenanceRequest, MaintenanceStatusPass, MaintenanceStatusStep, MappingId, MappingInfo,
    MergeOutcome, MigrationRequest, NameMappingDef, OptionScope, PartitionColumnDef, PartitionId,
    PartitionSpec, ReadOnlyCatalog, RecentRow, RowSummaryWarmth, ScheduledDeletion, SchemaId,
...
pub use store::cache_identity::CacheIdentity;
