...
## [0.7.0](https://github.com/morainedb/moraine/compare/v0.6.5...v0.7.0) - 2026-09-18
...
- read ahead past a swept index's tombstones in the maintenance sweep ([#220](https://github.com/morainedb/moraine/pull/220))

### Other

- stream the inline scan in windows instead of materializing the table ([#221](https://github.com/morainedb/moraine/pull/221))
- refresh row-lookup directories incrementally instead of rebuilding ([#219](https://github.com/morainedb/moraine/pull/219))
